...
**Review before opening a PR**, and always when touching boot/hardware or secrets.
...
| HIGH | build break | **block** |
| MEDIUM | maintainability / style | advisory |
| LOW | minor suggestion | optional |

Use the **security-reviewer** agent for secrets and boot/GPU changes.
