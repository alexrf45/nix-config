...
```
hosts/nitro5/          — Host entry, hardware-configuration.nix, disk docs
...
home-manager/nitro5/fr3d/  — User HM entry point
...
- **Overlays**: Declared in `hosts/nitro5/default.nix` — NOT inside home.nix
...
nixos-generate-config --show-hardware-config > hosts/nitro5/hardware-configuration.nix

# 3. Update PRIME bus IDs in modules/nixos/hardware.nix

# 4. Build and switch
sudo nixos-rebuild switch --flake .#nitro5
```
